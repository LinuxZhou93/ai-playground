...
专注执行力（在装配、编程、调试与竞技任务中的持续投入）: ${focus_score}/100
工程装配力（底盘、轮组、电机、机构、线路与工具操作的精细度）: ${dexterity_score}/100
系统逻辑力（理解机械运动、麦克纳姆轮向量、电路、通信、程序与控制关系）: ${logic_score}/100
调试韧性（面对偏航、接线异常、控制失灵或对战失利时的恢复与排错）: ${resilience_score}/100
工程规范力（安全操作、材料工具整理、接线标记、记录复测与任务秩序）: ${self_management_score}/100
竞技适应力（理解规则、临场反应、战术调整及与同伴导师的互动适应）: ${social_score}/100
创新设计力（底盘、装甲、发射机构、控制方案与战术优化中的创意）: ${creativity_score}/100
协作沟通力（项目分工、状态同步、共同调试与赛后复盘）: ${collaboration_score}/100
