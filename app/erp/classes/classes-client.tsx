...
export default function ClassesClient({ initialClasses, courses }: ClassesClientProps) {
  ...
  const avgFillRate = initialClasses.length > 0 ? Math.round(initialClasses.reduce((sum, c) => sum + (c.fillRate || 0), 0) / initialClasses.length) : 0;
            ...
            <div className="flex items-center gap-10 px-10 py-5 bg-white/40 dark:bg-zinc-900/40 backdrop-blur-2xl rounded-[2rem] border border-zinc-200/50 dark:border-zinc-800/50 shadow-2xl shadow-zinc-200/20 dark:shadow-none">
              <div className="relative">
                ...
                <div className="flex items-baseline gap-1">
                  <span className="text-4xl font-black text-blue-600 dark:text-blue-400 tabular-nums tracking-tighter">{initialClasses.length}</span>
