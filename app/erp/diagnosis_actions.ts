      ...
      card: {
        ...
        elements: [
          ...
          },
          {
            tag: "action",
            actions: [
              { tag: "button", text: { content: "跟进高危学员", tag: "plain_text" }, type: "primary", url: "https://your-domain.com/erp/students" },
              { tag: "button", text: { content: "合并班级", tag: "plain_text" }, type: "default", url: "https://your-domain.com/erp/classes" }
            ]
          }
        ]
      }
