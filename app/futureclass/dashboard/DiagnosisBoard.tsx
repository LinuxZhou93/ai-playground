          ...
          >
            ...
            <div className="relative z-10 flex flex-col h-full">
              <div className="flex items-center gap-3 mb-8">
                ...
                <div>
                  <h3 className="text-lg font-bold tracking-tight">AI 运营指挥官</h3>
                  <p className="text-[10px] text-zinc-400 dark:text-zinc-500 font-bold tracking-[0.2em] uppercase">Autonomous Directive</p>
                </div>
              </div>
