...
function StudentsContent() {
  ...
  const fetchAll = () => {
    setLoading(true);
    loadStudentsPageData().then(({ students: s, stats: st, courses: c, classes: cl }) => {
      setStudents(s);
      setStats(st);
      setCourses(c);
      setAllClasses(cl);
                            ...
                            <td className="p-8 text-right">
                              <DropdownMenu>
                                ...
                                <DropdownMenuContent align="end" className="w-72 rounded-[28px] border-zinc-200/50 dark:border-zinc-800/50 backdrop-blur-3xl bg-white/95 dark:bg-zinc-950/95 shadow-2xl p-4">
                                  ...
                                  <DropdownMenuItem className="rounded-2xl cursor-pointer py-4 px-5 focus:bg-zinc-100 dark:focus:bg-zinc-900 transition-colors font-bold text-base" onClick={() => router.push(`/futureclass/students/${student.id}`)}>
                                  ...
                                  <DropdownMenuItem className="rounded-2xl cursor-pointer py-4 px-5 focus:bg-zinc-100 dark:focus:bg-zinc-900 transition-colors font-bold text-base" onClick={() => router.push('/futureclass/attendance')}>
  ...
  return (
    <Suspense fallback={
      <div className="p-10 space-y-10 max-w-[1600px] mx-auto">
        ...
        <Card className="border-zinc-200/60 dark:border-zinc-800/60 rounded-[40px] overflow-hidden">
