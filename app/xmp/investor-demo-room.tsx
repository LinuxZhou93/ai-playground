...
const demoSteps = [
  ...
  },
  {
    ...
    time: "02:30",
    label: "现场交付",
    title: "AI 真正帮老师备课、授课和复盘，但方向盘始终在教师手中。",
    question: "产品如何真正进入课堂，而不是停留在备课阶段？",
    answer:
      "AI 教学驾驶舱把签名课程、桌宠近场、教室摄像头、Rokid 第一视角和教师现场动作放进一节课；边缘 AI 融合多端证据，课中建议与个体成长证据仍由教师决定。",
    proof: [
      "演示备课从 48 分钟缩短到 12 分钟",
      "90 秒班级聚合信号不保存原始媒体，不做儿童排名",
      "关键设备异常自动停 AI，恢复后仍由教师继续",
    ],
