...
const demoSteps = [
  ...
  },
  {
    ...
    answer:
      "课程工厂把目标、年龄、安全边界和材料条件转成结构化教案；教师可编辑，发布前保留审核门禁。",
    proof: [
      "多智能体生成流程可见",
      "课程阶段、材料与家庭延伸结构化",
      "生成结果不自动进入课堂",
  ...
  },
  {
    ...
    answer:
      "实时课堂统一教师台、课堂大屏与奇妙宠，支持节奏编排、现场 Copilot、静音和人工接管。",
    proof: [
      "教师启动、暂停和切换活动",
      "建议可接受也可忽略",
      "儿童端默认低认知负担与安全降级",
  ...
  },
  {
    ...
    answer:
      "FutureClass 的班级、排课、课消、库存与财务能力被重组为园所运营和标准化交付中心，并由设备舰队支撑现场稳定性。",
    proof: [
      "合同到 30 天陪跑的六阶段交付",
      "经营口径、审批和流水统一",
      "设备诊断、灰度发布与工单闭环",
  ...
  },
  {
    ...
    answer:
      "本地优先、目的限定、监护授权、最小访问、到期删除和证据审计被做成可操作控制；商业化由软件订阅、边缘硬件、实施与课程服务共同承载。",
    proof: [
      "授权、撤回、导出与删除可演示",
      "边缘处理减少原始数据外流",
      "审计证据链支撑园所采购与规模治理",
