window.Launchpad = (() => {
    ...
    const apps = [
        ...
        { name: '工业智能', icon: '⚙️', link: 'hub-auto-142.html', color: '#fb7185', category: 'discovery' },
        { name: '信息安全', icon: '⌨️', link: 'hub-auto-141.html', color: '#fb7185', category: 'discovery' },
        { name: '系统科学与工程', icon: '🔄', link: 'hub-auto-140.html', color: '#f87171', category: 'discovery' },
        { name: '柔性电子学', icon: '🩹', link: 'hub-auto-139.html', color: '#fb7185', category: 'discovery' },
        { name: '碳中和科学与工程', icon: '🍃', link: 'hub-auto-138.html', color: '#f472b6', category: 'discovery' },
        { name: '氢能科学与工程', icon: '💧', link: 'hub-auto-137.html', color: '#c084fc', category: 'discovery' },
        { name: '智能车辆工程', icon: '🚗', link: 'hub-auto-136.html', color: '#34d399', category: 'discovery' },
        { name: '智能交通工程', icon: '🚦', link: 'hub-auto-135.html', color: '#f87171', category: 'discovery' },
        { name: '物联网工程', icon: '🌐', link: 'hub-auto-134.html', color: '#f87171', category: 'discovery' },
        { name: '区块链工程', icon: '⛓️', link: 'hub-auto-133.html', color: '#2dd4bf', category: 'discovery' },
        { name: '虚拟现实技术', icon: '🕶️', link: 'hub-auto-132.html', color: '#f87171', category: 'discovery' },
        { name: '智能建造', icon: '🏗️', link: 'hub-auto-131.html', color: '#f472b6', category: 'discovery' },
        { name: '地理信息科学', icon: '📍', link: 'hub-auto-130.html', color: '#fbbf24', category: 'discovery' },
        { name: '遥感科学与技术', icon: '🛰️', link: 'hub-auto-129.html', color: '#f472b6', category: 'discovery' },
        { name: '地球信息科学与技术', icon: '🌍', link: 'hub-auto-128.html', color: '#2dd4bf', category: 'discovery' },
        { name: '深海探测与高技术装备', icon: '🚢', link: 'hub-auto-127.html', color: '#2dd4bf', category: 'discovery' },
        { name: '水声工程', icon: '🌊', link: 'hub-auto-126.html', color: '#fb7185', category: 'discovery' },
        { name: '海洋工程与技术', icon: '⚓', link: 'hub-auto-125.html', color: '#f87171', category: 'discovery' },
        { name: '无人驾驶航空器系统工程', icon: '🚁', link: 'hub-auto-124.html', color: '#2dd4bf', category: 'discovery' },
        { name: '飞行器设计与工程', icon: '✈️', link: 'hub-auto-123.html', color: '#818cf8', category: 'discovery' },
        { name: '航空航天工程', icon: '🚀', link: 'hub-auto-122.html', color: '#34d399', category: 'discovery' },
        { name: '脑科学与类脑智能', icon: '🧠', link: 'hub-auto-121.html', color: '#f87171', category: 'discovery' },
        { name: '合成生物学', icon: '🧪', link: 'hub-auto-120.html', color: '#f472b6', category: 'discovery' },
        { name: '生物信息学', icon: '🧬', link: 'hub-auto-119.html', color: '#f87171', category: 'discovery' },
        { name: '生物医学工程', icon: '🏥', link: 'hub-auto-118.html', color: '#2dd4bf', category: 'discovery' },
        { name: '辐射防护与核安全', icon: '⚠️', link: 'hub-auto-117.html', color: '#2dd4bf', category: 'discovery' },
        { name: '核工程与核技术', icon: '☢️', link: 'hub-auto-116.html', color: '#fb7185', category: 'discovery' },
        { name: '智能电网信息工程', icon: '⚡', link: 'hub-auto-115.html', color: '#2dd4bf', category: 'discovery' },
        { name: '新能源材料与器件', icon: '🔋', link: 'hub-auto-114.html', color: '#818cf8', category: 'discovery' },
        { name: '智能制造工程', icon: '🏭', link: 'hub-auto-113.html', color: '#2dd4bf', category: 'discovery' },
        { name: '光电信息科学与工程', icon: '🔦', link: 'hub-auto-112.html', color: '#f87171', category: 'discovery' },
        { name: '密码学', icon: '🔐', link: 'hub-auto-111.html', color: '#818cf8', category: 'discovery' },
        { name: '网络空间安全', icon: '🛡️', link: 'hub-auto-110.html', color: '#818cf8', category: 'discovery' },
        { name: '数据科学与大数据技术', icon: '📊', link: 'hub-auto-109.html', color: '#fbbf24', category: 'discovery' },
        { name: '机器人工程', icon: '🤖', link: 'hub-auto-108.html', color: '#f472b6', category: 'discovery' },
        { name: '智能科学与技术', icon: '👁️', link: 'hub-auto-107.html', color: '#818cf8', category: 'discovery' },
        { name: '人工智能', icon: '🧠', link: 'hub-auto-106.html', color: '#c084fc', category: 'discovery' },
        { name: '量子信息科学', icon: '⚛️', link: 'hub-auto-105.html', color: '#fbbf24', category: 'discovery' },
        { name: '集成电路设计与集成系统', icon: '💾', link: 'hub-auto-104.html', color: '#2dd4bf', category: 'discovery' },
        { name: '微电子科学与工程', icon: '🔬', link: 'hub-auto-103.html', color: '#fbbf24', category: 'discovery' },
        { name: '人形机器人技术', icon: '🤖', link: 'hub-auto-102.html', color: '#06b6d4', category: 'discovery' },
        { name: '脑机接口工程', icon: '🧠', link: 'hub-auto-101.html', color: '#8b5cf6', category: 'discovery' },
        { name: '智慧交通', icon: '🚗', link: 'hub-auto-100.html', color: '#fb7185', category: 'discovery' },
        { name: '纳米材料与技术', icon: '🔬', link: 'hub-auto-99.html', color: '#f472b6', category: 'discovery' },
        { name: '新能源科学与工程', icon: '☀️', link: 'hub-auto-98.html', color: '#34d399', category: 'discovery' },
        { name: '光电信息科学与工程', icon: '💡', link: 'hub-auto-97.html', color: '#818cf8', category: 'discovery' },
        { name: '智能无人系统工程', icon: '🤖', link: 'hub-auto-96.html', color: '#818cf8', category: 'discovery' },
        { name: '增材制造工程', icon: '🖨️', link: 'hub-auto-95.html', color: '#34d399', category: 'discovery' },
        { name: '氢能科学与工程', icon: '🔋', link: 'hub-auto-94.html', color: '#2dd4bf', category: 'discovery' },
        { name: '脑科学与工程', icon: '🧠', link: 'hub-auto-93.html', color: '#f472b6', category: 'discovery' },
        { name: '合成生物学', icon: '🧪', link: 'hub-auto-92.html', color: '#fbbf24', category: 'discovery' },
        { name: '仿生科学与工程', icon: '🦎', link: 'hub-auto-91.html', color: '#2dd4bf', category: 'discovery' },
        { name: '智能感知工程', icon: '📡', link: 'hub-auto-90.html', color: '#818cf8', category: 'discovery' },
        { name: '密码科学与技术', icon: '🔐', link: 'hub-auto-89.html', color: '#fb7185', category: 'discovery' },
        { name: '海洋机器人', icon: '🌊', link: 'hub-auto-88.html', color: '#2dd4bf', category: 'discovery' },
        { name: '飞行器控制与信息工程', icon: '🚀', link: 'hub-auto-87.html', color: '#818cf8', category: 'discovery' },
        { name: '集成电路设计与集成系统', icon: '💾', link: 'hub-auto-86.html', color: '#fbbf24', category: 'discovery' },
        { name: '柔性电子学', icon: '📱', link: 'hub-auto-85.html', color: '#818cf8', category: 'discovery' },
        { name: '碳储科学与工程', icon: '🌍', link: 'hub-auto-84.html', color: '#c084fc', category: 'discovery' },
        { name: '智能医学工程', icon: '🧬', link: 'hub-auto-83.html', color: '#bae6fd', category: 'discovery' },
        { name: '量子信息科学', icon: '⚛️', link: 'hub-auto-82.html', color: '#c084fc', category: 'discovery' },
        { name: '智能科学与技术', icon: '🧠', link: 'hub-auto-81.html', color: '#2dd4bf', category: 'discovery' },
        { name: '极地工程与前沿技术', icon: '🧊', link: 'hub-auto-80.html', color: '#34d399', category: 'discovery' },
        { name: '空间制造与在轨服务', icon: '🛠️', link: 'hub-auto-79.html', color: '#2dd4bf', category: 'discovery' },
        { name: '微纳机器人与精准医疗', icon: '🔬', link: 'hub-auto-78.html', color: '#c084fc', category: 'discovery' },
        { name: '硅光子与光计算工程', icon: '💡', link: 'hub-auto-77.html', color: '#2dd4bf', category: 'discovery' },
        { name: '低空经济与 eVTOL 工程', icon: '🚁', link: 'hub-auto-76.html', color: '#818cf8', category: 'discovery' },
        { name: '智能无人系统与集群技术', icon: '🐝', link: 'hub-auto-75.html', color: '#34d399', category: 'discovery' },
        { name: '柔性电子与生物集成系统', icon: '🩹', link: 'hub-auto-74.html', color: '#fbbf24', category: 'discovery' },
        { name: '先进核能与聚变技术', icon: '☀️', link: 'hub-auto-73.html', color: '#fbbf24', category: 'discovery' },
        { name: '碳封存与负排放技术', icon: '🌳', link: 'hub-auto-72.html', color: '#f472b6', category: 'discovery' },
        { name: '氢能与长时储能工程', icon: '🔋', link: 'hub-auto-71.html', color: '#fb7185', category: 'discovery' },
        { name: '脑机接口与类脑工程', icon: '🧠', link: 'hub-auto-70.html', color: '#2dd4bf', category: 'discovery' },
        { name: '合成生物制造', icon: '🧬', link: 'hub-auto-69.html', color: '#fbbf24', category: 'discovery' },
        { name: '量子信息工程', icon: '⚛️', link: 'hub-auto-68.html', color: '#fbbf24', category: 'discovery' },
        { name: '深地空间工程', icon: '🌏', link: 'hub-auto-67.html', color: '#fbbf24', category: 'discovery' },
        { name: '深空探测工程', icon: '🚀', link: 'hub-auto-66.html', color: '#2dd4bf', category: 'discovery' },
        { name: '极端环境材料工程', icon: '🛡️', link: 'hub-auto-65.html', color: '#fb7185', category: 'discovery' },
        { name: '工业智能', icon: '🏭', link: 'hub-auto-64.html', color: '#0EA5E9', category: 'discovery' },
        { name: '智能建造', icon: '🏗️', link: 'hub-auto-63.html', color: '#F59E0B', category: 'discovery' },
        { name: '机器人工程', icon: '🤖', link: 'hub-auto-62.html', color: '#F43F5E', category: 'discovery' },
        { name: '量子信息科学与工程', icon: '⚛️', link: 'hub-auto-61.html', color: '#A855F7', category: 'discovery' },
        { name: '柔性电子学', icon: '🦾', link: 'hub-auto-60.html', color: '#F472B6', category: 'discovery' },
        { name: '智慧海洋技术', icon: '🌊', link: 'hub-auto-59.html', color: '#06B6D4', category: 'discovery' },
        { name: '空天智能电网', icon: '🛰️', link: 'hub-auto-58.html', color: '#EAB308', category: 'discovery' },
        { name: '仿生科学与工程', icon: '🧬', link: 'hub-auto-57.html', color: '#84CC16', category: 'discovery' },
        { name: '集成电路设计与集成系统', icon: '🔲', link: 'hub-auto-56.html', color: '#38BDF8', category: 'discovery' },
        { name: '虚拟现实技术', icon: '🥽', link: 'hub-auto-55.html', color: '#D946EF', category: 'discovery' },
        { name: '智能医学工程', icon: '🏥', link: 'hub-auto-54.html', color: '#10B981', category: 'discovery' },
        { name: '区块链工程', icon: '🔗', link: 'hub-auto-53.html', color: '#C084FC', category: 'discovery' },
        { name: '数据科学与大数据技术', icon: '📊', link: 'hub-auto-52.html', color: '#F59E0B', category: 'discovery' },
        { name: '智能无人系统技术', icon: '🚁', link: 'hub-auto-51.html', color: '#0EA5E9', category: 'discovery' },
        { name: '智慧交通', icon: '🚦', link: 'hub-auto-50.html', color: '#F43F5E', category: 'discovery' },
        { name: '密码科学与技术', icon: '🔐', link: 'hub-auto-49.html', color: '#3B82F6', category: 'discovery' },
        { name: '智能测控工程', icon: '🎛️', link: 'hub-auto-48.html', color: '#0891B2', category: 'discovery' },
        { name: '智能感知工程', icon: '📡', link: 'hub-auto-47.html', color: '#10B981', category: 'discovery' },
        { name: '智能科学与技术', icon: '🧠', link: 'hub-auto-46.html', color: '#C084FC', category: 'discovery' },
        { name: '微电子科学与工程', icon: '🖥️', link: 'hub-auto-45.html', color: '#EAB308', category: 'discovery' },
        { name: '智能建造', icon: '🏗️', link: 'hub-auto-44.html', color: '#F59E0B', category: 'discovery' },
        { name: '新能源材料与器件', icon: '☀️', link: 'hub-auto-43.html', color: '#38BDF8', category: 'discovery' },
        { name: '机器人工程', icon: '🤖', link: 'hub-auto-42.html', color: '#EC4899', category: 'discovery' },
        { name: '智能制造工程', icon: '🦾', link: 'hub-auto-41.html', color: '#A855F7', category: 'discovery' },
        { name: '智慧矿山与采矿工程', icon: '⛏️', link: 'hub-auto-40.html', color: '#10b981', category: 'discovery' },
        { name: '循环经济与资源循环科学', icon: '🔄', link: 'hub-auto-39.html', color: '#10b981', category: 'discovery' },
        { name: '低温工程与深冷技术', icon: '❄️', link: 'hub-auto-38.html', color: '#10b981', category: 'discovery' },
        { name: '智能交通系统工程', icon: '🚦', link: 'hub-auto-37.html', color: '#10b981', category: 'discovery' },
        { name: '仿生机器人技术', icon: '🐾', link: 'hub-auto-36.html', color: '#10b981', category: 'discovery' },
        { name: '数字孪生技术与应用', icon: '🌐', link: 'hub-auto-35.html', color: '#10b981', category: 'discovery' },
        { name: '生物制造工程', icon: '🧪', link: 'hub-auto-34.html', color: '#10b981', category: 'discovery' },
        { name: '卫星互联网技术', icon: '🛰️', link: 'hub-auto-33.html', color: '#10b981', category: 'discovery' },
        { name: '工业互联网工程', icon: '🏭', link: 'hub-auto-32.html', color: '#10b981', category: 'discovery' },
        { name: '能源互联网工程', icon: '⚡', link: 'hub-auto-31.html', color: '#10b981', category: 'discovery' },
        { name: '生物医学材料与器械', icon: '🦴', link: 'hub-auto-30.html', color: '#10b981', category: 'discovery' },
        { name: '增材制造工程', icon: '🖨️', link: 'hub-auto-29.html', color: '#10b981', category: 'discovery' },
        { name: '深海探测与海洋矿产工程', icon: '⚓', link: 'hub-auto-28.html', color: '#10b981', category: 'discovery' },
        { name: '低空经济与无人系统工程', icon: '🚁', link: 'hub-auto-27.html', color: '#10b981', category: 'discovery' },
        { name: '类脑智能科学与技术', icon: '🤖', link: 'hub-auto-26.html', color: '#10b981', category: 'discovery' },
        { name: '脑机接口工程', icon: '🧠', link: 'hub-auto-25.html', color: '#10b981', category: 'discovery' },
        { name: '柔性电子学', icon: '📱', link: 'hub-auto-24.html', color: '#10b981', category: 'discovery' },
        { name: '智能电网信息工程', icon: '⚡', link: 'hub-auto-23.html', color: '#10b981', category: 'discovery' },
        { name: '储能科学与工程', icon: '🔋', link: 'hub-auto-22.html', color: '#10b981', category: 'discovery' },
        { name: '碳储科学与工程', icon: '🌿', link: 'hub-auto-21.html', color: '#10b981', category: 'discovery' },
