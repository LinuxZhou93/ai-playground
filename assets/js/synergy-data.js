...
const curriculumSeeds = {
    // === ELEMENTARY SCHOOL (Science/Math/General) ===
    'elementary': {
        'science': [
            ...
            "动物的繁殖", "身体的生长", "运动与呼吸", "我们的消化", "食物中的营养",
            "安全用电", "声音的变化", "制作乐器", "运动的小车", "能量的形式",
            "地球的运动", "昼夜交替", "四季成因", "浩瀚的宇宙", "探索月球"
        ],
        'math': [
            "100以内加减法", "乘法口诀", "除法初步", "混合运算", "分数的认识", "小数的认识",
            ...
            "简单的立体几何", "观察物体", "轴对称图形", "平移与旋转", "多位数乘除",
            "简易方程", "复式统计图", "圆的认识", "百分数", "比与比例", "负数初步",
            "圆柱与圆锥", "比例尺", "图形放大缩小", "正反比例", "数的整除", "质数合数",
            "公因数公倍数", "分数的基本性质", "分数加减法", "分数乘除法", "倒数的认识",
            "数学史趣闻", "阿基米德故事", "祖冲之与圆周率", "黄金分割", "斐波那契数列"
        ],
        'general': [
            "计算机基础", "鼠标键盘操作", "画图软件", "初识互联网", "信息安全", "Scratch初体验",
            "角色与舞台", "积木编程", "顺序结构", "简单循环", "侦测与判断", "广播消息",
            "认识人工智能", "生活中的AI", "体验语音识别", "人脸识别", "智能家居", "无人驾驶",
            "色彩原理", "构图基础", "创意绘画", "手工折纸", "泥塑造型", "剪纸艺术",
            "乐理基础", "节奏练习", "乐器启蒙", "音乐欣赏", "合唱训练", "身体协调",
            "自我保护", "交通安全", "防火防灾", "急救常识", "心理健康", "情绪管理",
            "古诗词背诵", "寓言故事", "神话传说", "成语接龙", "汉字演变", "书法欣赏",
            "English Phonics", "Sight Words", "Simple Conversation", "Children's Songs"
        ]
    },
    ...
    'middle': {
        ...
        'physics': [
            ...
            "能源与可持续", "北斗卫星", "航空航天", "火箭发射", "空间站", "失重现象",
            "新能源汽车", "锂电池", "太阳能发电", "风力发电", "核能应用", "磁悬浮列车",
            "5G技术", "量子通信", "暗物质", "黑洞", "引力波", "超导现象", "纳米技术"
        ],
        'chemistry': [
        ...
        'biology': [
            ...
            "生物进化", "传染病预防", "免疫与健康", "基因编辑", "转基因食品", "克隆技术",
            "仿生学", "显微镜使用", "植物组织培养", "外来物种", "低碳生活"
        ],
        'cs': [
            "信息社会", "计算机系统", "Python基础", "变量与类型", "分支结构", "循环结构",
            "列表与字典", "函数定义", "算法基础", "枚举算法", "排序算法", "网络基础",
            "人工智能初步", "物联网应用", "3D打印", "机器人组成", "海龟绘图", "字符串处理",
            "文件读写", "异常处理", "第三方库", "Pygame开发", "简单爬虫", "数据可视化",
            "词云制作", "Arduino硬件", "传感器应用", "Micro:bit", "手机App开发"
        ]
    },
    ...
    'high': {
        ...
        'general': [
            ...
            "Web全栈", "Linux系统", "网络安全", "云计算", "哲学与生活", "经济学原理",
            "政治学概论", "社会学视野", "心理学基础", "逻辑学", "伦理学", "艺术史", "批判性思维"
        ]
    },
    ...
    'university': {
        'math': [
            "Mathematical Analysis", "Linear Algebra", "Analytic Geometry", "Probability Theory",
            "Statistics", "ODEs", "PDEs", "Real Analysis", "Complex Analysis", "Functional Analysis",
            "Abstract Algebra", "Topology", "Number Theory", "Differential Geometry", "Numerical Analysis",
            "Operations Research", "Discrete Math", "Combinatorics", "Graph Theory", "Fuzzy Math"
        ],
        'physics': [
            "Theoretical Mechanics", "Thermodynamics", "Electrodynamics", "Quantum Mechanics",
            "Solid State Physics", "Optics", "Nuclear Physics", "Astrophysics", "Particle Physics",
            "General Relativity", "Fluid Mechanics", "Plasma Physics", "Condensed Matter"
        ],
        'chemistry': [
            "Inorganic Chemistry", "Organic Chemistry", "Physical Chemistry", "Analytical Chemistry",
            "Structural Chemistry", "Biochemistry", "Polymer Chemistry", "Materials Chemistry",
            "Chemical Engineering", "Spectroscopy", "Quantum Chemistry", "Surface Chemistry"
        ],
        'cs': [
            "Data Structures", "Algorithms", "Operating Systems", "Computer Networks", "Database Systems",
            "Software Engineering", "Artificial Intelligence", "Machine Learning", "Computer Graphics",
            "Computer Architecture", "Deep Learning", "NLP", "Computer Vision", "Distributed Systems",
            "Cloud Computing", "Big Data", "Cybersecurity", "Blockchain", "IoT", "Quantum Computing"
        ],
        'general': [
            "Microeconomics", "Macroeconomics", "Econometrics", "Finance", "Accounting", "Marketing",
            "Game Theory", "International Trade", "Psychology", "Sociology", "Philosophy", "History",
            "Linguistics", "Political Science", "Anthropology", "Law", "Logic Design", "Digital Circuits",
            "Signals & Systems", "Control Theory", "Embedded Systems", "Robotics"
        ]
    }
};
