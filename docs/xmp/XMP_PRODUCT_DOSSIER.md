...
当前本地版本已用统一课堂关联 ID 和追加式本地事件流连接课程发布、教学调度、AI 教学驾驶舱、智慧学情、教学策略复用、智慧课堂感知、实时课堂、成长审核、家庭发布、设备处置与访问控制。课程版本必须经过独立教研审核、八项安全门禁和发布经理签名；教学计划进一步验证教师、空间、设备包三类资源冲突和课程、教师、空间、设备、物料五项就绪。AI 教学驾驶舱再把这些资产转成老师的一节课；智慧课堂感知中枢把奇妙宠、教师端、教室大屏、匿名回应板和材料观察站输出压缩成 90 秒班级聚合信号，不保存原始声音、画面或儿童身份。AI 只能提出可解释建议，教师必须采纳或修改后才能应用；关键设备离线、安全接管或课程阶段变化都会阻止执行。应用动作进入课后匿名学情复证，经过教师跨课堂验证和独立教研审核后，才可能成为可复用策略；复用也只创建需再次验证的课程草稿。身份与治理能力是教学底座，不是产品主叙事。跨页面操作可以在“教学闭环事件链”中复盘；服务端迁移层尚未在真实园所数据库执行或接入生产身份与设备证书。
...
| 课程版本、课堂洞察、教师确认事实与教研审核能力                                    | 教学策略库：候选准入、证据谱系、独立审核、课程适配与再验证   | 本地策略协议     | 多教师小规模复用并验证策略成熟度               |
| 课堂舞台、媒体链路、设备心跳、边缘运行能力与课程阶段                              | 智慧课堂感知：90 秒班级聚合信号、AI 可解释建议、教师现场干预 | 本地感知协议     | 接入边缘代理与真实设备，开展教师标注校准       |
...
3. **物理—数字一体化**：奇妙宠、教师台、大屏、匿名回应板、材料站和边缘节点共同形成可感知、可干预、可复证的现场教学能力。
