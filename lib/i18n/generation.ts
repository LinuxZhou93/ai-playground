export const generationZhCN = {
  ...
  generation: {
    ...
    generatingOutlines: '绘制学习光谱',
    generatingOutlinesDesc: '正在构建认知层级与神经元递进式教学节点...',
    generatingSlideContent: '渲染多元实境舱',
    generatingSlideContentDesc: '正在编译智适应全息幻灯片、探究沙盘与微缩互动模型...',
    generatingActions: '映射教学动线',
    generatingActionsDesc: '正在编排多模态导师讲解逻辑、三维聚焦点与交互剧情...',
    ...
    // Agent generation
    agentGeneration: '实例化课堂角色',
    agentGenerationDesc: '正在根据当前知识边界加载专属数字导师及科研小组伙伴...',
    agentRevealTitle: '你的共创学习团队',
    viewAgents: '查看角色',
    continue: '继续',
    // Outline errors
