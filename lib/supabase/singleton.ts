...
import { buildSafeSupabaseAnonKey, buildSafeSupabaseUrl, isSupabasePublicConfigured } from './config'
...
export function getSupabase() {
  ...
  if (!isSupabasePublicConfigured) {
    console.warn('[Supabase] Singleton is using the inert local demo endpoint.');
  }

  singletonClient = createSupabaseClient(buildSafeSupabaseUrl, buildSafeSupabaseAnonKey, {
    auth: {
