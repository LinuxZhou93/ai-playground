...
const syncMap = [
  { web: "基地实景展示", mini: "首页了解基地、查看状态、预约参访", component: "基地介绍 / 状态服务" },
  { web: "臻萃产品系列", mini: "查看商品、加入购物车、提交订单", component: "便捷选购 / 会员复购" },
  { web: "数字基地与溯源", mini: "输入批次号或扫码查询产品来源", component: "批次查询 / 可查可追" },
  { web: "研学康养体验", mini: "预约活动、查看权益、留存服务记录", component: "活动预约 / 会员服务" }
];
...
const products = [
  ...
  },
  {
    ...
    name: "灵芝采收研学套票",
    price: 199,
    desc: "亲子研学、学校活动和企业团建均可预约，承接线下体验转化。",
...
const trace = {
  ...
  timeline: [
    ...
    { step: "04", title: "流通服务", desc: "产品二维码、手机端查询和会员服务统一承接。" }
  ]
};
