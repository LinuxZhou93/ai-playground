...
export const TTS_PROVIDERS: Record<TTSProviderId, TTSProviderConfig> = {
  ...
  'volcengine-tts': {
    ...
    voices: [
      ...
      {
        id: 'zh_child_tongtong_moon_bigtts',
        name: '童童 (甜美小女孩)',
        language: 'zh-CN',
        gender: 'female',
        description: '天真无邪的幼童女声',
      },
      {
        id: 'zh_child_cancan_moon_bigtts',
        name: '灿灿 (元气女童)',
        language: 'zh-CN',
        gender: 'female',
        description: '朝气蓬勃的女孩原声',
      },
      {
        id: 'zh_child_feifei_moon_bigtts',
        name: '飞飞 (活力男童)',
        language: 'zh-CN',
        gender: 'male',
        description: '充满能量的小男孩',
      },
      {
        id: 'zh_child_doudou_moon_bigtts',
        name: '豆豆 (活泼男童)',
        language: 'zh-CN',
        gender: 'male',
        description: '调皮开朗的男童音',
      },
      {
        id: 'zh_child_guoguo_moon_bigtts',
        name: '果果 (可爱女童)',
        language: 'zh-CN',
        gender: 'female',
        description: '软萌乖巧的小女孩',
      },
      {
        id: 'zh_child_nuonuo_moon_bigtts',
        name: '糯糯 (奶气幼童)',
        language: 'zh-CN',
        gender: 'neutral',
        description: '牙牙学语的小毛孩音',
      },
      {
        id: 'zh_female_xiaoyuan_moon_bigtts',
        name: '小元 (元气少女)',
        language: 'zh-CN',
        gender: 'female',
        description: '活力四射的校园少女',
      },
      {
        id: 'zh_male_xiaoming_moon_bigtts',
        name: '小明 (阳光男孩)',
        language: 'zh-CN',
        gender: 'male',
      ...
      },
      {
        ...
        language: 'zh-CN',
        gender: 'female',
        description: '语重心长循循善诱的老师',
      },
      {
        id: 'zh_female_xinxin_moon_bigtts',
        name: '馨馨 (知心姐姐)',
        language: 'zh-CN',
        gender: 'female',
        description: '温柔如水的大姐姐',
      },
      {
      ...
      },
      {
        ...
        language: 'zh-CN',
        gender: 'female',
        description: '温和沉稳的成年女讲师',
      },
      {
        id: 'zh_male_boba_moon_bigtts',
        name: '正气播报',
        language: 'zh-CN',
        gender: 'male',
        description: '标准的教育播报男声',
      },
      {
