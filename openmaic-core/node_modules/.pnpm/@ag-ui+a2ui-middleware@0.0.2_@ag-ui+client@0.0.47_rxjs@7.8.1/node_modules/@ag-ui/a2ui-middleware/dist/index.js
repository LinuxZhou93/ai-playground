"use strict";var f=Object.defineProperty,C=Object.defineProperties,O=Object.getOwnPropertyDescriptor,R=Object.getOwnPropertyDescriptors,E=Object.getOwnPropertyNames,U=Object.getOwnPropertySymbols;var x=Object.prototype.hasOwnProperty,k=Object.prototype.propertyIsEnumerable;var w=(r,e,t)=>e in r?f(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t,y=(r,e)=>{for(var t in e||(e={}))x.call(e,t)&&w(r,t,e[t]);if(U)for(var t of U(e))k.call(e,t)&&w(r,t,e[t]);return r},g=(r,e)=>C(r,R(e));var N=(r,e)=>{for(var t in e)f(r,t,{get:e[t],enumerable:!0})},M=(r,e,t,n)=>{if(e&&typeof e=="object"||typeof e=="function")for(let o of E(e))!x.call(r,o)&&o!==t&&f(r,o,{get:()=>e[o],enumerable:!(n=O(e,o))||n.enumerable});return r};var _=r=>M(f({},"__esModule",{value:!0}),r);var q={};N(q,{A2UIActivityType:()=>v,A2UIMiddleware:()=>A,A2UI_PROMPT:()=>L,LOG_A2UI_EVENT_TOOL_NAME:()=>b,SEND_A2UI_JSON_TOOL:()=>T,SEND_A2UI_TOOL_NAME:()=>u,extractSurfaceIds:()=>D,getOperationSurfaceId:()=>h,tryParseA2UIOperations:()=>I});module.exports=_(q);var m=require("crypto"),c=require("@ag-ui/client"),j=require("rxjs");var u="send_a2ui_json_to_client",b="log_a2ui_event",T={name:u,description:"Sends A2UI JSON to the client to render rich UI for the user. This tool can be called multiple times in the same call to render multiple UI surfaces. Args: a2ui_json: Valid A2UI JSON Schema to send to the client. The A2UI JSON Schema definition is between ---BEGIN A2UI JSON SCHEMA--- and ---END A2UI JSON SCHEMA--- in the system instructions.",parameters:{type:"object",properties:{a2ui_json:{type:"string",description:"Valid A2UI JSON Schema to send to the client."}},required:["a2ui_json"]}};var L=`---BEGIN A2UI JSON SCHEMA---
...
---END A2UI JSON SCHEMA---`;function I(r){let e;try{e=JSON.parse(r)}catch(t){return null}return Array.isArray(e)?e.some(n=>typeof n=="object"&&n!==null&&h(n)!==void 0)?e:null:typeof e=="object"&&e!==null&&h(e)!==void 0?[e]:null}function h(r){var s,i,l;let e=r.beginRendering,t=r.surfaceUpdate,n=r.dataModelUpdate,o=r.deleteSurface;return(l=(i=(s=e==null?void 0:e.surfaceId)!=null?s:t==null?void 0:t.surfaceId)!=null?i:n==null?void 0:n.surfaceId)!=null?l:o==null?void 0:o.surfaceId}function D(r){let e=new Set;for(let t of r){let n=h(t);n&&e.add(n)}return Array.from(e)}var v="a2ui-surface",A=class extends c.Middleware{constructor(e={}){super(),this.config=e}run(e,t){let n=this.processUserAction(e),o=this.config.injectA2UITool?this.injectTool(n):n;return this.processStream(this.runNextWithState(o,t))}processUserAction(e){var S;let t=e.forwardedProps,n=(S=t==null?void 0:t.a2uiAction)==null?void 0:S.userAction;if(!n)return e;let o=(0,m.randomUUID)(),s=(0,m.randomUUID)(),i=(0,m.randomUUID)(),l={id:o,role:"assistant",content:"",toolCalls:[{id:s,type:"function",function:{name:b,arguments:JSON.stringify(n)}}]},a=this.formatUserActionResult(n),p={id:i,role:"tool",toolCallId:s,content:a},d=[...e.messages||[],l,p];return g(y({},e),{messages:d})}formatUserActionResult(e){var l,a;let t=(l=e.name)!=null?l:"unknown_action",n=(a=e.surfaceId)!=null?a:"unknown_surface",o=e.sourceComponentId,s=e.context?JSON.stringify(e.context):"{}",i=`User performed action "${t}" on surface "${n}"`;return o&&(i+=` (component: ${o})`),i+=`. Context: ${s}`,i}injectTool(e){let t=e.tools.filter(n=>n.name!==u);return g(y({},e),{tools:[...t,T]})}processStream(e){return new j.Observable(t=>{let n=null,o=new Set,s=e.subscribe({next:i=>{let l=i.event;if(l.type===c.EventType.TOOL_CALL_START){let a=l;a.toolCallName===u&&o.add(a.toolCallId)}if(n&&(t.next(n.event),n=null),l.type===c.EventType.RUN_FINISHED)n=i;else if(t.next(l),l.type===c.EventType.TOOL_CALL_RESULT){let a=l;if(!o.has(a.toolCallId)){let p=I(a.content);if(p)for(let d of this.createA2UIActivityEvents(p))t.next(d)}}},error:i=>{n&&(t.next(n.event),n=null),t.error(i)},complete:()=>{if(n){let l=this.findPendingToolCalls(n.messages).filter(a=>a.function.name===u);for(let a of l){let p=this.processSendA2UIToolCall(a.id,a.function.arguments);for(let d of p)t.next(d)}t.next(n.event),n=null}t.complete()}});return()=>s.unsubscribe()})}findPendingToolCalls(e){let t=[];for(let o of e)o.role==="assistant"&&"toolCalls"in o&&o.toolCalls&&t.push(...o.toolCalls);let n=new Set;for(let o of e)o.role==="tool"&&"toolCallId"in o&&n.add(o.toolCallId);return t.filter(o=>!n.has(o.id))}processSendA2UIToolCall(e,t){let n=[],o={};if(typeof t=="string")try{o=JSON.parse(t||"{}")}catch(a){console.warn("[A2UIMiddleware] Failed to parse tool call arguments:",a)}else typeof t=="object"&&t!==null&&(o=t);let s=o.a2ui_json,i=[];if(typeof s=="string")try{let a=JSON.parse(s);Array.isArray(a)?i=a:typeof a=="object"&&a!==null&&(i=[a])}catch(a){console.warn("[A2UIMiddleware] Failed to parse A2UI JSON string:",a)}else Array.isArray(s)?i=s:typeof s=="object"&&s!==null?i=[s]:console.warn("[A2UIMiddleware] a2ui_json has unexpected type:",typeof s);n.push(...this.createA2UIActivityEvents(i));let l={type:c.EventType.TOOL_CALL_RESULT,messageId:(0,m.randomUUID)(),toolCallId:e,content:JSON.stringify(i)};return n.push(l),n}createA2UIActivityEvents(e){var o;let t=[],n=new Map;for(let s of e){let i=(o=h(s))!=null?o:"default";n.has(i)||n.set(i,[]),n.get(i).push(s)}for(let[s,i]of n){let l=`a2ui-surface-${s}`,a={type:c.EventType.ACTIVITY_DELTA,messageId:l,activityType:v,patch:i.map(d=>({op:"add",path:"/operations/-",value:d}))};t.push(a);let p={type:c.EventType.ACTIVITY_SNAPSHOT,messageId:l,activityType:v,content:{operations:i},replace:!1};t.push(p)}return t}};0&&(module.exports={A2UIActivityType,A2UIMiddleware,A2UI_PROMPT,LOG_A2UI_EVENT_TOOL_NAME,SEND_A2UI_JSON_TOOL,SEND_A2UI_TOOL_NAME,extractSurfaceIds,getOperationSurfaceId,tryParseA2UIOperations});
