var w=Object.defineProperty,x=Object.defineProperties;var j=Object.getOwnPropertyDescriptors;var b=Object.getOwnPropertySymbols;var C=Object.prototype.hasOwnProperty,O=Object.prototype.propertyIsEnumerable;var T=(l,e,t)=>e in l?w(l,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):l[e]=t,f=(l,e)=>{for(var t in e||(e={}))C.call(e,t)&&T(l,t,e[t]);if(b)for(var t of b(e))O.call(e,t)&&T(l,t,e[t]);return l},y=(l,e)=>x(l,j(e));import{randomUUID as m}from"crypto";import{Middleware as R,EventType as d}from"@ag-ui/client";import{Observable as E}from"rxjs";var u="send_a2ui_json_to_client",I="log_a2ui_event",v={name:u,description:"Sends A2UI JSON to the client to render rich UI for the user. This tool can be called multiple times in the same call to render multiple UI surfaces. Args: a2ui_json: Valid A2UI JSON Schema to send to the client. The A2UI JSON Schema definition is between ---BEGIN A2UI JSON SCHEMA--- and ---END A2UI JSON SCHEMA--- in the system instructions.",parameters:{type:"object",properties:{a2ui_json:{type:"string",description:"Valid A2UI JSON Schema to send to the client."}},required:["a2ui_json"]}};var M=`---BEGIN A2UI JSON SCHEMA---
...
---END A2UI JSON SCHEMA---`;function A(l){let e;try{e=JSON.parse(l)}catch(t){return null}return Array.isArray(e)?e.some(n=>typeof n=="object"&&n!==null&&h(n)!==void 0)?e:null:typeof e=="object"&&e!==null&&h(e)!==void 0?[e]:null}function h(l){var a,i,s;let e=l.beginRendering,t=l.surfaceUpdate,n=l.dataModelUpdate,o=l.deleteSurface;return(s=(i=(a=e==null?void 0:e.surfaceId)!=null?a:t==null?void 0:t.surfaceId)!=null?i:n==null?void 0:n.surfaceId)!=null?s:o==null?void 0:o.surfaceId}function _(l){let e=new Set;for(let t of l){let n=h(t);n&&e.add(n)}return Array.from(e)}var S="a2ui-surface",U=class extends R{constructor(e={}){super(),this.config=e}run(e,t){let n=this.processUserAction(e),o=this.config.injectA2UITool?this.injectTool(n):n;return this.processStream(this.runNextWithState(o,t))}processUserAction(e){var g;let t=e.forwardedProps,n=(g=t==null?void 0:t.a2uiAction)==null?void 0:g.userAction;if(!n)return e;let o=m(),a=m(),i=m(),s={id:o,role:"assistant",content:"",toolCalls:[{id:a,type:"function",function:{name:I,arguments:JSON.stringify(n)}}]},r=this.formatUserActionResult(n),c={id:i,role:"tool",toolCallId:a,content:r},p=[...e.messages||[],s,c];return y(f({},e),{messages:p})}formatUserActionResult(e){var s,r;let t=(s=e.name)!=null?s:"unknown_action",n=(r=e.surfaceId)!=null?r:"unknown_surface",o=e.sourceComponentId,a=e.context?JSON.stringify(e.context):"{}",i=`User performed action "${t}" on surface "${n}"`;return o&&(i+=` (component: ${o})`),i+=`. Context: ${a}`,i}injectTool(e){let t=e.tools.filter(n=>n.name!==u);return y(f({},e),{tools:[...t,v]})}processStream(e){return new E(t=>{let n=null,o=new Set,a=e.subscribe({next:i=>{let s=i.event;if(s.type===d.TOOL_CALL_START){let r=s;r.toolCallName===u&&o.add(r.toolCallId)}if(n&&(t.next(n.event),n=null),s.type===d.RUN_FINISHED)n=i;else if(t.next(s),s.type===d.TOOL_CALL_RESULT){let r=s;if(!o.has(r.toolCallId)){let c=A(r.content);if(c)for(let p of this.createA2UIActivityEvents(c))t.next(p)}}},error:i=>{n&&(t.next(n.event),n=null),t.error(i)},complete:()=>{if(n){let s=this.findPendingToolCalls(n.messages).filter(r=>r.function.name===u);for(let r of s){let c=this.processSendA2UIToolCall(r.id,r.function.arguments);for(let p of c)t.next(p)}t.next(n.event),n=null}t.complete()}});return()=>a.unsubscribe()})}findPendingToolCalls(e){let t=[];for(let o of e)o.role==="assistant"&&"toolCalls"in o&&o.toolCalls&&t.push(...o.toolCalls);let n=new Set;for(let o of e)o.role==="tool"&&"toolCallId"in o&&n.add(o.toolCallId);return t.filter(o=>!n.has(o.id))}processSendA2UIToolCall(e,t){let n=[],o={};if(typeof t=="string")try{o=JSON.parse(t||"{}")}catch(r){console.warn("[A2UIMiddleware] Failed to parse tool call arguments:",r)}else typeof t=="object"&&t!==null&&(o=t);let a=o.a2ui_json,i=[];if(typeof a=="string")try{let r=JSON.parse(a);Array.isArray(r)?i=r:typeof r=="object"&&r!==null&&(i=[r])}catch(r){console.warn("[A2UIMiddleware] Failed to parse A2UI JSON string:",r)}else Array.isArray(a)?i=a:typeof a=="object"&&a!==null?i=[a]:console.warn("[A2UIMiddleware] a2ui_json has unexpected type:",typeof a);n.push(...this.createA2UIActivityEvents(i));let s={type:d.TOOL_CALL_RESULT,messageId:m(),toolCallId:e,content:JSON.stringify(i)};return n.push(s),n}createA2UIActivityEvents(e){var o;let t=[],n=new Map;for(let a of e){let i=(o=h(a))!=null?o:"default";n.has(i)||n.set(i,[]),n.get(i).push(a)}for(let[a,i]of n){let s=`a2ui-surface-${a}`,r={type:d.ACTIVITY_DELTA,messageId:s,activityType:S,patch:i.map(p=>({op:"add",path:"/operations/-",value:p}))};t.push(r);let c={type:d.ACTIVITY_SNAPSHOT,messageId:s,activityType:S,content:{operations:i},replace:!1};t.push(c)}return t}};export{S as A2UIActivityType,U as A2UIMiddleware,M as A2UI_PROMPT,I as LOG_A2UI_EVENT_TOOL_NAME,v as SEND_A2UI_JSON_TOOL,u as SEND_A2UI_TOOL_NAME,_ as extractSurfaceIds,h as getOperationSurfaceId,A as tryParseA2UIOperations};
