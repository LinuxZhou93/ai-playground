...
var CopilotRuntime$1 = class {
	...
	get instance() {
		if (!this._instance) this._instance = new CopilotRuntime(this.runtimeArgs);
...
//#endregion
export { CopilotRuntime$1 as CopilotRuntime, copilotKitEndpoint, langGraphPlatformEndpoint, resolveEndpointType };
