...
test("the portal keeps fullscreen while stations use one clear return control", () => {
  ...
  assert.doesNotMatch(app, /FullscreenButton/);
  assert.equal((app.match(/station-back-to-portal/g) || []).length, 1);
